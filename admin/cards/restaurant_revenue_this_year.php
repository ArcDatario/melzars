<div class="col-xxl-4 col-md-6" style="display:none;" id="restaurant_revenue_this_year">
  ...
  <div class="card info-card customers-card">
    ...
    <div class="filter">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
        ...
        <li><a class="dropdown-item restaurant_revenue_this_year active" href="#"  onclick="showRestaurantRevenueThisYear()">This Year</a></li>
        <li><a class="dropdown-item restaurant_overall_revenue" href="#"  onclick="showRestaurantOverallRevenue()">Overall</a></li>
      </ul>
    </div>

    <div class="card-body">
      <h5 class="card-title">Restaurant<span>| This Year</span></h5>
  ...
  $query_current_year = "SELECT IFNULL(SUM(total), 0) as total_revenue_current_year FROM orders WHERE YEAR(order_date) = '$current_year'";
  ...
  $query_previous_year = "SELECT IFNULL(SUM(total), 0) as total_revenue_previous_year FROM orders WHERE YEAR(order_date) = '$previous_year'";
  ...
  echo '<h6 id="sales_year">₱' . number_format($total_revenue_current_year, 0) . '</h6>';

  // Display percentage change and increase/decrease with the determined class
  echo '<span class="' . $class . ' small pt-1 fw-bold" id="percentage_year">' . abs($percentage_change) . '%</span>';
  echo '<span class="text-muted small pt-2 ps-1" id="text_change_year">' . ($percentage_change >= 0 ? 'increase' : 'decrease') . '</span>';
  ?>
