<div class="col-xxl-4 col-md-6" style="display:none;" id="restaurant_revenue_this_month">
  ...
  <div class="card info-card customers-card">
    ...
    <div class="filter">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
        ...
        <li><a class="dropdown-item restaurant_revenue_this_month active" href="#" onclick="showRestaurantRevenueThisMonth()">This Month</a></li>
    ...
    <div class="card-body">
      <h5 class="card-title">Restaurant <span>| This Month</span></h5>
  ...
  echo '<h6 id="sales_month">₱' . number_format($total_revenue_current_month, 0) . '</h6>';

  // Display percentage change and increase/decrease with the determined class
  echo '<span class="' . $class . ' small pt-1 fw-bold" id="percentage_month">' . abs($percentage_change) . '%</span>';
  echo '<span class="text-muted small pt-2 ps-1" id="text_change_month">' . ($percentage_change >= 0 ? 'increase' : 'decrease') . '</span>';
  ?>
