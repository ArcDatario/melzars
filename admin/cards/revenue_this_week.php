<div class="col-xxl-4 col-md-6" style="display:none;" id="revenue_this_week">
  <div class="card info-card revenue-card">
    ...
    <div class="filter">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
        ...
        <li><a class="dropdown-item revenue_this_week active" href="#" onclick="showRevenueThisWeek()">This Week</a></li>
    ...
    <div class="card-body">
      <h5 class="card-title">Bookings<span>| This week</span></h5>
...
$query_current_week = "SELECT IFNULL(SUM(total), 0) as total_revenue_current_week FROM bookings WHERE occupied_status = 'Occupied' AND DATE(occupied_date) BETWEEN '$current_week_start' AND '$current_date'";
...
$query_previous_week = "SELECT IFNULL(SUM(total), 0) as total_revenue_previous_week FROM bookings WHERE occupied_status = 'Occupied' AND DATE(occupied_date) BETWEEN '$previous_week_start' AND '$date_6_days_ago'";
