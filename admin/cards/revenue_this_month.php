<div class="col-xxl-4 col-md-6" style="display:none;" id="revenue_this_month">
  ...
  echo '<h6 id="booking_sales_month">₱' . number_format($total_revenue_current_month, 0) . '</h6>';

  // Display percentage change and increase/decrease with the determined class
  echo '<span class="' . $class . ' small pt-1 fw-bold" id="booking_percentage_month">' . abs($percentage_change) . '%</span>';
  echo '<span class="text-muted small pt-2 ps-1" id="booking_text_change_month">' . ($percentage_change >= 0 ? 'increase' : 'decrease') . '</span>';
  ?>
