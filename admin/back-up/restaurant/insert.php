...
if (isset($_SESSION['cart'])) {
    ...
    if (!isset($_SESSION['order_number'])) {
        $_SESSION['order_number'] = 1; // Initialize the order_number counter if not set
    } else {
        $_SESSION['order_number']++;
   // Increment the order_number counter for each batch of orders
    }
    $orderNumber = $_SESSION['order_number']; // Get the current order_number
