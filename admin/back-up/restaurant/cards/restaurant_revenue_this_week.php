<div class="col-xxl-12 col-md-12" style="display:none;" id="restaurant_revenue_this_week">

  <div class="card info-card customers-card">

    <div class="filter">
      <a class="icon" href="#" data-bs-toggle="dropdown" style=""><i class="bi bi-three-dots"></i></a>
    ...
    <div class="card-body">
      <h5 class="card-title"><span>Sales|This Week</span></h5>
