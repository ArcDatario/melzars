<div class="col-xxl-4 col-md-6" style="display:none;" id="revenue_this_yesterday">
  <div class="card info-card revenue-card">
    ...
    <div class="filter">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
        ...
        <li><a class="dropdown-item revenue_this_yesterday  active" href="#" onclick="showRevenueThisYesterday()">Yesterday</a></li>
    ...
    <div class="card-body">
      <h5 class="card-title">Revenue <span>| Yesterday</span></h5>
...
$query_yesterday_revenue = "SELECT IFNULL(SUM(total), 0) as total_revenue_yesterday FROM bookings WHERE occupied_status = 'Occupied' AND DATE(occupied_date) = '$yesterday_date'";
