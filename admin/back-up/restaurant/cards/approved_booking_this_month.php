<div class="col-xxl-4 col-md-6" style="display:none;" id="approved_booking_this_month">
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item booking_this_today" href="#" onclick="showBookingThisDay()">Today</a></li>
                      ...
                      <li><a class="dropdown-item booking_this_week" href="#" onclick="showBookingThisWeek()">This Week</a></li>
                ...
                <div class="card-body">
                  <h5 class="card-title">Approved<span>| <script>var monthNames = ["January", "February", "March", "April", "May", "June",
...
echo '<h6>' . $total_approved_current_month . '</h6>';
echo '<span class="' . $class . ' small pt-1 fw-bold">' . $percentage_change . '%</span>';

// Determine whether it's an increase or decrease
if ($percentage_change >= 0) {
    echo '<span class="text-muted small pt-2 ps-1">increase</span>';
} else {
    echo '<span class="text-muted small pt-2 ps-1">decrease</span>';
}
