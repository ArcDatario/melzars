        ...
        success: function(response) {
            ...
            Swal.fire({
                ...
                html: `<form id="editForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              <label for="category" class="modal_label">Room Category</label>
                              <select id="category" class="swal2-input" name="category" style="border:1px solid #D0D2D6; border-radius:6px;">
                                <option value="Classic Room" ${room.category === 'Classic Room' ? 'selected' : ''}>Classic Room</option>
                                <option value="Family Room" ${room.category === 'Family Room' ? 'selected' : ''}>Family Room</option>
                                <option value="Premium Room" ${room.category === 'Premium Room' ? 'selected' : ''}>Premium Room</option>
                              </select>
                            </div>
                            <div class="form-group">
