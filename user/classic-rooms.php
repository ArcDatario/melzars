...
?>
            ...
            <ul>
                ...
                <li><a href="pages.html">Rooms</a>
                    <ul class="dropdown">
                        ...
                        <li><a href="classic-rooms.php">Classic Rooms</a></li>
                        <li><a href="family-rooms.php">Family Rooms</a></li>
                        <li><a href="premium-rooms.php">Premium Rooms</a></li>
                    </ul>
                </li>
    ...
    <section class="rooms-section spad">
      ...
      $query = "SELECT * FROM rooms_tbl where category='Classic Room'";
  ...
  ?>
    ...
    <label class="text-sm text-gray-400 font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">G-cash Reciept-Reservation Fee(₱1000) <a class="view-qr" href="#"> View QR </a> </label>
