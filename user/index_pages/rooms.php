...
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
    ...
    <script>
        window.embeddedChatbotConfig = {
            chatbotId: "48ycav0J5UrmpCg0yKMh9",
            domain: "www.chatbase.co"
        };
    </script>
    <script src="https://www.chatbase.co/embed.min.js" chatbotId="48ycav0J5UrmpCg0yKMh9" domain="www.chatbase.co" defer></script>
...
?>
  ...
  ?>
    ...
    var session_id = "<?php echo session_id(); ?>"; // Get the current session ID
    $.ajax({
...
// Function to send message to chatbot and server
function sendToChatbot(message) {
    window.embeddedChatbot.sendMessage(message); // Send message to chatbot
    sendMessageToServer(message); // Send message to server for storing conversation history
}
       </script>
