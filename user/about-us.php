        ...
        <div class="container">
            <div class="about-page-text">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ap-title">
                            <h2>Welcome To Melzar's Mountain Resort</h2>
            ...
            <div class="about-page-services">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="ap-service-item set-bg" data-setbg="img/about/ZIpline.png">
                            <div class="api-text">
                                <h3>ZIpline</h3>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-text">
                        ...
                        <p>Melzar's Mountain Resort</p>
                        <a href="https://www.youtube.com/watch?v=A9ZfSaOklUQ" class="play-btn video-popup"><img
        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="gallery-item set-bg" data-setbg="img/gallery/gallery-1.jpg" style=" width: 100%;height:278px; ">
                        <div class="gi-text">
                            <h3>Room Luxury</h3>
                        </div>
                    </div>
