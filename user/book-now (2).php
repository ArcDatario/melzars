      ...
      <nav class="mainmenu mobile-menu">
          <ul>
              ...
              <li><a href="pages.html">Rooms</a>
                  <ul class="dropdown">
                      <li><a href="index_rooms.php">All Rooms</a></li>

                      <li><a href="#">Family Room</a></li>
                      <li><a href="#">Premium Room</a></li>
                  </ul>
              </li>
                <li><a href="index_restaurant.php">Restaurant</a></li>
              <li><a href="index_about-us.php">About Us</a></li>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6">
                      <div class="tn-right">
                          ...
                          <a href="sign-up.php" class="bk-btn">Booking Now</a>
                          ...
                          <nav class="mainmenu">
                              <ul>
                                  ...
                                  <li class="active"><a href="#">Rooms</a>
                                      <ul class="dropdown">
                                          <li class="active"><a href="index_rooms.php" class="active">All Rooms</a></li>
                                          <li><a href="#">Family Room</a></li>
                                          <li><a href="#">Premium Room</a></li>
                                      </ul>
                                  </li>
        ...
        <div id="carouselExample<?php echo $row['id']; ?>" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="<?php echo $row['image1']; ?>" height="300" width="300" class="d-block w-100 room-image" alt="Image 1">
            </div>
            <div class="carousel-item">
              <img src="<?php echo $row['image2']; ?>" height="300" width="300" class="d-block w-100 room-image" alt="Image 2">
            </div>
            <div class="carousel-item">
              <img src="<?php echo $row['image3']; ?>" height="300" width="300" class="d-block w-100 room-image" alt="Image 3">
            </div>
          </div>
          ...
          <div class="rd-text">
              <div class="rd-title">
                  ...
                  <div class="rdt-right">
                                    ...
                                    <a href="sign-up.php" class="book_now-btn rooms_book_now_btn"
                        >Book Now</a>
                        </div>
              </div>
...
?>
  ...
  ?>
    ...
    $(document).ready(function() {
        $(".book_now-btn1").click(function(e) {
