                ...
                <div class="row">
                  ...
                  ?>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="hp-room-item set-bg" data-setbg="../admin/<?php echo $image1;?>" style="height: 550px !important;">
                                <div class="hr-text" style="backdrop-filter: blur(3px); background-color: rgba(0, 0, 0, 0.5);">
                                    ...
                                    <a href="
                                    book-now.php?id=<?php echo $id; ?>&user_id=<?php echo $_SESSION['user_id']; ?>
